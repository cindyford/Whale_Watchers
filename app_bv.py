...
def year(yr,mo,spec,type,pod):
    ...
    if (yr != '0' and mo != '0' and spec != '0' and type != '0' and pod != '0'):
        exit = session.query(ta).filter(ta.year==yr).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).filter(ta.orca_pod.like('%'+pod+'%')).all()
    # elif if only one item was all
    elif (yr != '0' and mo != '0' and spec != '0' and type != '0'):
        exit = session.query(ta).filter(ta.year==yr).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).all()
    elif (yr != '0' and mo != '0' and spec != '0' and pod != '0'):
        exit = session.query(ta).filter(ta.year==yr).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_pod.like('%'+pod+'%')).all()
        ...
        exit = session.query(ta).filter(ta.year==yr).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).filter(ta.orca_pod.like('%'+pod+'%')).all()
    elif (mo != '0' and spec != '0' and type != '0' and pod != '0'):
        exit = session.query(ta).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).filter(ta.orca_pod.like('%'+pod+'%')).all()
    # elif if only two item's was all
    elif (spec != '0' and type != '0' and pod != '0'): #yr,mo all
        exit = session.query(ta).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).filter(ta.orca_pod.like('%'+pod+'%')).all()
        ...
        exit = session.query(ta).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_pod.like('%'+pod+'%')).all()
        ...
        exit = session.query(ta).filter(ta.year==yr).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_pod.like('%'+pod+'%')).all()
    elif (yr != '0' and spec != '0' and type != '0'): #mo, pod all
        exit = session.query(ta).filter(ta.year==yr).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).all()
        ...
        exit = session.query(ta).filter(ta.year==yr).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).all()
    # elif if only three item's was all
        ...
        exit = session.query(ta).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_pod.like('%'+pod+'%')).all()
    elif (spec != '0' and type != '0'): #yr, mo, pod
        exit = session.query(ta).filter(ta.species.like('%'+spec+'%')).filter(ta.orca_type==type).all()
        ...
        exit = session.query(ta).filter(ta.month==mo).filter(ta.species.like('%'+spec+'%')).all()
        ...
        exit = session.query(ta).filter(ta.year==yr).filter(ta.species.like('%'+spec+'%')).all()
...
# elif if only four item's was all
        ...
        exit = session.query(ta).filter(ta.species.like('%'+spec+'%')).all()
    elif (mo != '0'):
